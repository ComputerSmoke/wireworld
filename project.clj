(defproject wireworld "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "wireworld.core/on-js-reload"
                ...
                :compiler {:main wireworld.core
                           ...
                           :output-to "resources/public/js/compiled/wireworld.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/wireworld.js"
                           :main wireworld.core
